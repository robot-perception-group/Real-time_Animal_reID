...
from rapid.modules.visualization.visualize_FalseTagFinder import false_tag_finder_plot
from rapid.modules.database import build_db, load_db
...
def main():
    ...
    for curr_img_filename in tqdm(
        os.listdir(db_imgs), desc="Searching for possibly wrong labels: "
    ):
        #############################
        # Module-1: PreProc
        #############################
        ...
        if pred != q_animal_id:
            false_tag_finder_plot(
                save_dir=wrong_matches,
